...
public class ControllersTests
{
    ...
    public async Task AeropuertosController_CrearAeropuerto_SinPilotoId_BadRequest()
    {
        ...
        var controller = new AeropuertosController(aeropuertosService, pilotosService, CreateContext());
    ...
    public async Task VuelosController_CrearVuelo_OK()
    {
        ...
        var controller = new VuelosController(vuelosService);
    ...
    private static SkySyncDbContext CreateContext()
    {
        var options = new DbContextOptionsBuilder<SkySyncDbContext>()
            .UseInMemoryDatabase($"SkySyncTests_{System.Guid.NewGuid():N}")
            .Options;
